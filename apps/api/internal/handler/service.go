...
// NewServiceHandler wires up a ServiceHandler.
func NewServiceHandler(db *pgxpool.Pool, ks *appssh.KeyStore) *ServiceHandler {
	return &ServiceHandler{repo: repository.NewServiceRepository(db), ks: ks}
}
